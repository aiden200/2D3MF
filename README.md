...
python preprocess/celebvhq_extract.py --data_dir yt_mixed --backbone marlin_vit_base_ytf --config config/celebv_hq/appearance/celebvhq_marlin_deepfake_ft.yaml
